...
class NewsSentimentService:
    ...
    def _create_sentiment_prompt(self, news_text: str) -> str:
        ...
        9. **risk_score** (numeric): A score from 0 (no risk) to 10 (extreme risk). This should be derived based on the identified risk factors and reflect the overall risk level — **higher values indicate higher risk**.
